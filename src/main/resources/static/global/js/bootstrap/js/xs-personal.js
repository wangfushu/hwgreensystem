$(function(){
	...
	$("#spwdOld").on('mouseover',function(){
		$('#pwdOld').prop('type', 'text'); 
	});
	$("#spwdOld").on('mouseout',function(){
		$('#pwdOld').prop('type', 'password');
	});
	$("#spwdNew").on('mouseover',function(){
		$('#pwdNew').prop('type', 'text'); 
	});
	$("#spwdNew").on('mouseout',function(){
		$('#pwdNew').prop('type', 'password');
	});
	$("#sconfirm_password").on('mouseover',function(){
		$('#confirm_password').prop('type', 'text'); 
	});
	$("#sconfirm_password").on('mouseout',function(){
