                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="signupForm">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input id="userNo" name="userNo" readonly="readonly" class="form-control" type="text"
                                       value="${user.userNo!""}">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input id="plazaId" name="sysPlaza.plazaId" class="hidden"
                                       value="${user.sysPlaza.plazaId}">
                                <input
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <#list roles as role>
                                    <label class="radio-inline">
                                        <input name="roleId" type="radio" value="${role.id}" <#if role.id==roleSign>
                                               checked</#if> >${role.remark}
                                    </label>
                                </#list>
                            </div>
                        </div>
