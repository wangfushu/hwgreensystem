...
<div class="wrapper wrapper-content ">
    <div class="col-sm-12">
        ...
        <#--<div class="columns pull-left">
           ...
           年份:<input id="logmin" name="dateTime" type="text" value="${param.dateTime!''}" runat="server"
                   onfocus="WdatePicker({skin:'default',dateFmt:'yyyy'})" class="inputDate form-control Wdate"
                   style="width:120px;"/>
        </div>
...
<script type="text/javascript">
    ...
    function load() {
        ...
        $('#exampleTable').bootstrapTable({
            ...
            url: "/report/YearPageReport", // 服务器数据的加载地址
            iconSize: 'outline',
    ...
    function export_excel() {
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data) {
                    window.location.href = "/report/yearExport" + param;
